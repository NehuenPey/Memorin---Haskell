...
-Cómo jugar
Ingresá el nombre de ambos jugadores.
Cada jugador escribe una palabra secreta (se muestra con guiones).
Los jugadores se turnan para:
  Ingresar una letra, o
  Arriesgar la palabra completa.
Cada jugador tiene 5 intentos.
Gana quien adivina la palabra antes de quedarse sin intentos.
